...
namespace objwriter
{
	...
	public:
		...
		void point()
		{
			m_file << "POINTS" << std::endl;
		}
		void polys()
		{
			m_file << "POLYS" << std::endl;
		}
		void end()
		{
			m_file << "END" << std::endl;
		...
		void vertex(TVertex v1, TVertex v2, TVertex v3, int idx)
		{
			m_file << std::to_string(idx + 1) + ": "
				<< v1 << " "
				<< v2 << " "
				<< v3 << std::endl;
		}
		...
		*/
		...
		void tet(TIndex v1, TIndex v2, TIndex v3, TIndex v4, int idx)
		{
			m_file << std::to_string(idx + 1) + ":"
				<< v1 << " "
				<< v2 << " "
